...
public class PizzaApp {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        Pizza anotherPizza = new Pizza("Margarita", PizzaSize.LARGE);
        ...
        System.out.println("sameOrder's hashcode: " + samePizza.hashCode());
        System.out.println("anotherOrder's hashcode: " + anotherPizza.hashCode());
