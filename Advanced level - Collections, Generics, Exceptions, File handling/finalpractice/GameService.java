package advanced.finalpractice;
...
public class GameService {
    ...
    private static final String SRC_ADVANCED_FINAL_PRACTICE_WORD_TXT = "src/advanced/finalpractice/words.txt";
    ...
    public void start() throws FileNotFoundException {
        ...
        System.out.println("The word: " + new String(guessingArray)); //Arrays.toString(guessingArray)
    ...
    private List<String> getTheWords() throws FileNotFoundException {
        ...
        File wordsFile = new File(SRC_ADVANCED_FINAL_PRACTICE_WORD_TXT);
