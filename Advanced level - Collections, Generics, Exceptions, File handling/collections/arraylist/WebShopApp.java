...
public class WebShopApp {
    ...
    public static void main(String[] args) {
        ...
        products.add(new Product("Earbud", 33.99, "Extremely clear sound. Waterproof."));
        products.add(new Product("Earbud", 33.99, "Extremely clear sound. Waterproof."));

        products.add(1, new Product("36 AA batteries", 10.99, "High-performance alkaline batteries")); //prosthese seira

        products.remove(2);
        //products.remove(new Product("Earbud", 33.99, "Extremely clear sound. Waterproof."));
