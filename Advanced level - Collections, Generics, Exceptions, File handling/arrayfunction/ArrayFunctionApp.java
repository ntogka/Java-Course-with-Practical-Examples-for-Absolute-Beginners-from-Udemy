package advanced.arrayfunction;
...
public class ArrayFunctionApp {
    ...
    public static void main(String[] args) {
        ...
        Arrays.fill(gamerPoints, 0, 10, 180); // apo to 0 ews to 10 bale 180
        System.out.println(Arrays.toString(gamerPoints));
        ...
        System.out.println(gamerPoints.length);
        ...
        gamerPoints[4] = 300;
        Arrays.sort(gamerPoints); //allios de vlepei oti kapoios eftase tous 300 bathmous
