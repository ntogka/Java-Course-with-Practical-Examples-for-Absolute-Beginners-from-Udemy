...
public class HashSetOperationsApp {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("The least reliable car brands that can be found our dealership: "
        //        + carBrands);

        carBrands.retainAll(leastReliableCarBrands);
        System.out.println("After the list reliable cars are sold: " + carBrands);
