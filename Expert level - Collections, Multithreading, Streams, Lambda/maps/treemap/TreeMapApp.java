...
public class TreeMapApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("LinkedHashMap: "); //ta krataei se seira
        ...
        //productPricesTreeMap.put(null, 0.15); //pote null sto treemap

        System.out.println();
        System.out.println("TreeMap: "); //alfabitiki seira
