...
public class AthleteApp {
    ...
    public static void main(String[] args) {
        ...
        FootballPlayer ed = new FootballPlayer("Ed Brady", "Ed Terrific", 1979, "New England Patriots", 255, 8988, 4377);
        ...
        Swimmer katinka = new Swimmer("Katina Hosszu", "Iron lady", 1989, "Team Iron", 542, 845);
        System.out.println("--------------------------------------------------");
        katinka.compete();
        System.out.println("--------------------------------------------------");
        katinka.getBio();
